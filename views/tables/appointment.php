                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row text-center">
                                ...
                                <?php
                                /**
                                 * Haalt de aangepaste velden op voor Appointly afspraken en geeft deze weer.
                                 *
                                 * - Haalt eerst de aangepaste velden op met get_custom_fields()
                                 * - Loopt door de velden heen en haalt de waarde op met get_custom_field_value()
                                 * - Als er velden met waarden zijn, wordt de koptekst getoond
                                 * - Elk veld met een waarde wordt weergegeven
                                 * - De naam en waarde (of '-' als leeg) worden getoond
                                 */
