...
/**
 * Voeg een actie toe om de aangepaste velden voor Appointly toe te voegen 
 * aan de selectieopties voor aangepaste velden.
 *
 * @param object $custom_field Het aangepaste veld object.
 */
